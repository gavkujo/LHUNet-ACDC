...
import numpy as np
import torch
from lhunet.training.data_augmentation.data_augmentation_moreDA import (
    get_moreDA_augmentation,
)
from lhunet.training.loss_functions.deep_supervision import MultipleOutputLoss2
from lhunet.utilities.to_torch import maybe_to_torch, to_cuda
from lhunet.network_architecture.initialization import InitWeights_He
from lhunet.network_architecture.neural_network import SegmentationNetwork
from lhunet.training.data_augmentation.default_data_augmentation import (
    default_2D_augmentation_params,
    get_patch_size,
    default_3D_augmentation_params,
)
from lhunet.training.dataloading.dataset_loading import unpack_dataset
from lhunet.training.network_training.Trainer_acdc import Trainer_acdc
from lhunet.utilities.nd_softmax import softmax_helper
from sklearn.model_selection import KFold
from torch import nn
from torch.cuda.amp import autocast
from lhunet.training.learning_rate.poly_lr import poly_lr
from batchgenerators.utilities.file_and_folder_operations import *
from lhunet.network_architecture.acdc.lhunet.models.v7 import LHUNet as LHUNet_V7
from fvcore.nn import FlopCountAnalysis


class lhunet_trainer_acdc(Trainer_acdc):
    """
